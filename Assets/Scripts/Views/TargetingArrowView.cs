...
namespace Views
{
    public class TargetingArrowView : MonoBehaviour
    {
        ...
        {
            this.playerHandViewCamera = playerHandView.Camera;
        ...
        public void DrawCurveForCardAndScreenPoint(Vector3 cardPosition, Vector2 screenPoint)
        {
            ...
            for (int i = 0; i < playerHandViewSettings.NumberOfArrowPiecesForTargetingArrow; i++)
            {
                ...
                arrowPieces[i].transform.rotation = Quaternion.Euler(0f, 0f, -ArrowRotation.x * Computations.Normalize(i, 0, playerHandViewSettings.NumberOfArrowPiecesForTargetingArrow, 1, 175f));
